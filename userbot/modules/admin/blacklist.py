...
async def append(key, option, value):
...
async def unappend(key, option, value):
...
@register(outgoing=True, pattern=r"^.blacklist, regex=bl_pattern")
async def blacklister(event):
...
@register(outgoing=True, pattern=r"^.rmblacklist, regex=dbl_pattern")
async def unblacklister(event):
...
@register(outgoing=True, pattern=r"^.whitelist, regex=wl_pattern")
async def whitelister(event):
...
@register(outgoing=True, pattern=r"^.rmwhitelist, regex=dwl_pattern")
async def unwhitelister(event):
...
@register(outgoing=True, pattern=r"^.blacklists, regex=bls_pattern")
async def listbls(event):
...
@register(outgoing=True, pattern=r"^.whitelists, regex=wls_pattern")
async def listwls(event):
...
async def escape_string(string):
...
async def is_admin(chat_id, sender_id):
...
async def blattributes(blacklist):
